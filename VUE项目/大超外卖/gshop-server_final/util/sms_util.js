...
function sendCode(phone, code, callback) {
    var ACCOUNT_SID = '8aaf0708780055cd01782fbea12a1089'; // 可以改成自己的
    var AUTH_TOKEN = '4dd9fdbecb8349a98da7a9428f4fc922'; // 可以改成自己的
    var Rest_URL = 'https://app.cloopen.com:8883';
    var AppID = '8aaf0708780055cd01782fbea235108f'; // 可以改成自己的
    //1. 准备请求url
    /*
