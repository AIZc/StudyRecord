          ...
          <div class="content-left">
            <div class="logo-wrapper">
              <div @click="toggleCartShow" class="logo " :class="{highlight: totalCount}">
                <i class="iconfont icon-che" :class="{highlight: totalCount}"></i>
              </div>
...
<script>
  ...
  import {CLEAR_CARTSHOPS,SAVE_CARTSHOPS} from '../../store/mutations-type'
  ...
  export default {
    ...
    methods: {
      ...
      toOrderFill(){
        this.$store.commit(SAVE_CARTSHOPS,this.cartShops)
        this.$router.replace('/ordertofill')
      }
    },
    watch: {
      cartShops(newValue){
