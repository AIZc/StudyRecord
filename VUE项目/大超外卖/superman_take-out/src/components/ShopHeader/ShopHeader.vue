  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="isShowNotice=true">
    ...
    <div class="shop-header-discounts">
      <div class="discounts-left">
        <div class="activity activity-green" @click="isShowDiscount=true">
          <span class="content-tag">
    ...
    <div class="shop-brief-modal" v-show="isShowNotice" >
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-lianxi2hebing-05" @click="isShowNotice=false"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="isShowDiscount" >
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-lianxi2hebing-05" @click="isShowDiscount=false"></span>
        </div>
      </div>
