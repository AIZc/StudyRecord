...
(function () {
    ...
    var nav_items = floor.querySelectorAll('.nav-item')
    var lcContainer = document.querySelector('.container');
    var lcwrapper = lcContainer.querySelector('.swiper-wrapper');
    var slides = lcContainer.querySelectorAll('.swiper-slide');
    var movingborder = document.querySelector('.floor .moving-border')
